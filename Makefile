...
graphic_main: ./gui/src/remote_n_local.cpp ./gui/src/local.cpp ./src/search_manager.cpp ./src/file_finder.cpp 
	g++ $(CPPFLAGS) ./gui/src/remote_n_local.cpp ./gui/src/local.cpp ./src/search_manager.cpp ./src/file_finder.cpp -I ./gui/include -I ./include $$(pkg-config --cflags gtkmm-4.0) $$(pkg-config --libs gtkmm-4.0)
